...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('C:/Python36/Attendace_system_major_project/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("C:\Python36\Attendace_system_major_project\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
